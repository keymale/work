...
class Layer:
    def __init__(self, previous_layer, num_nuerons, learning_rate, activation_funcation, derivative_activation_function):
        ...
        for i in range(num_nuerons):
            ...
            neuron = Neuron(random_weights,learning_rate, activation_funcation, derivative_activation_function)
            self.neurons.append(neuron)
        self.output_cache = [0.0 for _ in range(num_nuerons)]
